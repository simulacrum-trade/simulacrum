...
This will build simulacrum-qt as well, if the dependencies are met.
...
If you want to build simulacrum-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a simulacrum-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip simulacrumd" to strip the debug
