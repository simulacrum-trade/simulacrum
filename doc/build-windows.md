...
Acquire the source in the usual way:
    ...
    git clone https://github.com/simulacrum-project/simulacrum.git
    cd simulacrum
...
example /usr/src/simulacrum, AND not under /mnt/d/. If this is not the case the dependency autoconf scripts will fail.
...
way. This will install to `c:\workspace\simulacrum`, for example:

    make install DESTDIR=/mnt/c/workspace/simulacrum
