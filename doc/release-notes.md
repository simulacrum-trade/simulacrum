...
PIVX Core version *version* is now available from:  <https://github.com/simulacrum-project/simulacrum/releases>
...
For our linux users, in addition to the [Ubuntu PPA](https://launchpad.net/~simulacrum) repository, we are now offering a [Snap package](https://snapcraft.io/simulacrum-core) as quick way to install and update a PIVX wallet.
