...
The script [extract-osx-sdk.sh](https://github.com/simulacrum-project/simulacrum/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
simulacrum/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/simulacrum-project/simulacrum/blob/master/doc/README_osx.md) for troubleshooting tips.