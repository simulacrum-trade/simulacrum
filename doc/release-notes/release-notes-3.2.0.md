PIVX Core version *3.2.0* is now available from:  <https://github.com/simulacrum-project/simulacrum/releases>
...
A full report provided by PIVX developers is available on the [PIVX Website](https://simulacrum.org/fake-stake-official-simulacrum-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
...
A full technical writeup of the protocol can be found [Here](https://simulacrum.org/wp-content/uploads/2018/11/Zerocoin_Light_Node_Protocol.pdf).
