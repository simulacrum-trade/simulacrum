...
#include "qt/simulacrum/send.h"
#include "qt/simulacrum/forms/ui_send.h"
#include "qt/simulacrum/addnewcontactdialog.h"
#include "qt/simulacrum/qtutils.h"
#include "qt/simulacrum/sendchangeaddressdialog.h"
#include "qt/simulacrum/optionbutton.h"
#include "qt/simulacrum/sendconfirmdialog.h"
#include "qt/simulacrum/myaddressrow.h"
...
SendWidget::SendWidget(SCMGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can transfer public coins (SCM)"));
    ...
    /* Address */
    ui->labelSubtitleAddress->setText(tr("Enter a SCM address or contact label"));
    ...
    ui->labelAmountSend->setText("0.00 SCM");
