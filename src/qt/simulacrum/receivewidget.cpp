...
#include "qt/simulacrum/forms/ui_receivewidget.h"
...
#include "qt/simulacrum/addressholder.h"
...
ReceiveWidget::ReceiveWidget(SCMGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive SCM."));
