...
#include "qt/simulacrum/forms/ui_dashboardwidget.h"
#include "qt/simulacrum/sendconfirmdialog.h"
#include "qt/simulacrum/txrow.h"
...
DashboardWidget::DashboardWidget(SCMGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    ui->labelAmountPiv->setText("0 SCM");
    ...
    ui->btnHowTo->setText(tr("How to get SCM"));
