...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, SCMGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, SCMGUI *gui, double posX = 3);
