...
#include "qt/simulacrum/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(SCMGUI* _window, QWidget *parent) :
...
void SettingsSignMessageWidgets::onAddressBookButtonSCMlicked(){
...
void SettingsSignMessageWidgets::onPasteButtonSCMlicked(){
...
void SettingsSignMessageWidgets::onSignMessageButtonSCMlicked(){
