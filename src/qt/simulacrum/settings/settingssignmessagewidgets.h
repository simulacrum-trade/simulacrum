...
#include "qt/simulacrum/contactsdropdown.h"
...
public:
    explicit SettingsSignMessageWidgets(SCMGUI* _window, QWidget *parent = nullptr);
...
public slots:
    void onSignMessageButtonSCMlicked();
    void onVerifyMessage();
    void onPasteButtonSCMlicked();
    void onAddressBookButtonSCMlicked();
    void onGoClicked();
    void onClearAll();
