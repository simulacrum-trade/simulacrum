...
#include "qt/simulacrum/settings/settingsnetworkwidget.h"
#include "qt/simulacrum/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/simulacrum/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SCMGUI* _window, QWidget *parent) :
