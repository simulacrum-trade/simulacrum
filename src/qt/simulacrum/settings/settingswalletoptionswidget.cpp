...
#include "qt/simulacrum/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/simulacrum/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SCMGUI* _window, QWidget *parent) :
