...
#include "qt/simulacrum/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/simulacrum/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SCMGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SCMGUI::handleRestart()
