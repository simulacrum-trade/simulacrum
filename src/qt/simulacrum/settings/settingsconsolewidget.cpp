...
#include "qt/simulacrum/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/simulacrum/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SCMGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the SCM RPC console.") + "<br>" +
...
void SettingsConsoleWidget::changeTheme(bool isLightTheme, QString &theme)
{
    ...
    if (isLightTheme) {
        ui->messagesWidget->document()->setDefaultStyleSheet(
                ...
                "td.message { color: #002040;font-family: Courier, Courier New, Lucida Console, monospace; font-size: 12px; } " // Todo: Remove fixed font-size
