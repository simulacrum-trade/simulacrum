...
#include "qt/simulacrum/forms/ui_privacywidget.h"
#include "qt/simulacrum/qtutils.h"
#include "guiutil.h"
#include "qt/simulacrum/denomgenerationdialog.h"
...
PrivacyWidget::PrivacyWidget(SCMGUI* parent) :
    PWidget(parent),
    ui(new Ui::PrivacyWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("Minting zPIV anonymizes your SCM by removing any\ntransaction history, making transactions untraceable "));
    ...
    ui->lineEditAmount->setPlaceholderText("0.00 SCM ");
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select SCM outputs to mint into zPIV.");
...
void PrivacyWidget::onMintSelected(bool isMint){
    ...
    if(isMint){
        ...
        ui->labelSubtitleAmount->setText(tr("Enter amount of SCM to mint into zPIV"));
    }else{
