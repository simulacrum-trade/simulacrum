...
#include "qt/simulacrum/forms/ui_addresseswidget.h"
#include "qt/simulacrum/addresslabelrow.h"
#include "qt/simulacrum/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(SCMGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter a SCM address"));
    setCssProperty(ui->labelAddress, "text-title");
    ui->lineEditAddress->setPlaceholderText("e.g. S7VFR83SQbiezrW72hjc…");
