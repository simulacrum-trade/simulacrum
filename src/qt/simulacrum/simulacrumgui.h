...
#ifndef SCM_CORE_NEW_GUI_SCMGUI_H
#define SCM_CORE_NEW_GUI_SCMGUI_H
...
#include "qt/simulacrum/navmenuwidget.h"
#include "qt/simulacrum/topbar.h"
#include "qt/simulacrum/dashboardwidget.h"
#include "qt/simulacrum/send.h"
#include "qt/simulacrum/receivewidget.h"
#include "qt/simulacrum/addresseswidget.h"
#include "qt/simulacrum/privacywidget.h"
#include "qt/simulacrum/masternodeswidget.h"
#include "qt/simulacrum/snackbar.h"
#include "qt/simulacrum/settings/settingswidget.h"
...
*/
class SCMGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SCMGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SCMGUI();
...
#endif //SCM_CORE_NEW_GUI_SCMGUI_H
