...
#include <QWidget>
#include <QString>
#include "qt/simulacrum/prunnable.h"
...
class PWidget : public QWidget, public Runnable
{
    Q_OBJECT
public:
    explicit PWidget(SCMGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    SCMGUI* getWindow() { return this->window; }
