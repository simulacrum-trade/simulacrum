...
#include "qt/simulacrum/forms/ui_masternodeswidget.h"
#include "qt/simulacrum/qtutils.h"
#include "qt/simulacrum/mnrow.h"
#include "qt/simulacrum/mninfodialog.h"

#include "qt/simulacrum/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(SCMGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:59472 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
