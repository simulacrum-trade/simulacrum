...
#include "qt/simulacrum/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/simulacrum/lockunlock.h"
#include "qt/simulacrum/qtutils.h"
#include "qt/simulacrum/receivedialog.h"
...
TopBar::TopBar(SCMGUI* _mainWindow, QWidget *parent) :
