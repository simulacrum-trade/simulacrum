...
#include "qt/simulacrum/coincontrolpivwidget.h"
#include "qt/simulacrum/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select SCM Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("SCM");
    ...
    ui->labelValueAfter->setText("0.00 SCM");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 SCM");
    ui->labelValueFee->setText("0.00 SCM");
