...
#include "qt/simulacrum/coldstakingwidget.h"
#include "qt/simulacrum/forms/ui_coldstakingwidget.h"
#include "qt/simulacrum/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/simulacrum/requestdialog.h"
#include "qt/simulacrum/tooltipmenu.h"
#include "qt/simulacrum/furlistrow.h"
#include "qt/simulacrum/sendconfirmdialog.h"
#include "qt/simulacrum/addnewcontactdialog.h"
#include "qt/simulacrum/guitransactionsutils.h"
#include "walletmodel.h"
#include "optionsmodel.h"
#include "coincontroldialog.h"
#include "coincontrol.h"
#include "qt/simulacrum/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(SCMGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your SCMs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept SCM delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select SCM outputs to delegate.");
...
void ColdStakingWidget::onCoinControlClicked(){
    if(isInDelegation) {
        if (walletModel->getBalance() > 0) {
            ...
            inform(tr("You don't have any SCM to select."));
        }
    }
}
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 SCM" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
