...
#include "qt/simulacrum/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 59472");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("59474");
    } else {
        ui->lineEditPort->setText("59472");
    }
