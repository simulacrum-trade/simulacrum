...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Simulacrum");
    ...
    QString copyrightTextSCM = QChar(0xA9) + QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("Simulacrum developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextSCM);
