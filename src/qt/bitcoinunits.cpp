...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SCM:
        return QString("simulacrum");
    case mSCM:
        return QString("msimulacrum");
    case uSCM:
        return QString::fromUtf8("usimulacrum");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit, bool isZpiv)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case SCM:
            return z + QString("SCM");
        case mSCM:
            return z + QString("mSCM");
        case uSCM:
            return z + QString::fromUtf8("μSCM");
        default:
            return QString("???");
        }
    } else {
