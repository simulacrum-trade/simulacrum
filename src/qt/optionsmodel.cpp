...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset){
    ...
    if (settings.contains("nAnonymizePivxAmount") || reset)
        SoftSetArg("-anonymizesimulacrumamount", settings.value("nAnonymizePivxAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in simulacrum.cpp during shotdown to also remove the window positions
