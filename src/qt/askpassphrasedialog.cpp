...
#include "qt/simulacrum/loadingdialog.h"
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            if (newpass1 == newpass2) {
                ...
                SCMGUI* window = static_cast<SCMGUI*>(parentWidget());
...
{
    SCMGUI* gui = static_cast<SCMGUI*>(parentWidget());
...
{
    hide();
    static_cast<SCMGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
