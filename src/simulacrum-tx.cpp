...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pivx Core simulacrum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  simulacrum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded simulacrum transaction") + "\n" +
                               "  simulacrum-tx [options] -create [commands]   " + _("Create hex-encoded simulacrum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded simulacrum transaction
