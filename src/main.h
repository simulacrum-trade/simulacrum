...
inline int64_t GetMasternodeCollateral(int nHeight){
    ...
    //1000 collateral for the first 3 months
    if (nHeight > 0 && nHeight <= 129600) {
        return 1000;
    //5000 collateral between 3rd month and 6th month
    } else if (nHeight > 129600 && nHeight <= 259200) {
        return 5000;
    //10000 collateral between 6th month and 1.5 years
    } else if (nHeight > 259200 && nHeight <= 777600) {
        return 10000;
    //25000 after 1.5 years
