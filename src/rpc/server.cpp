...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Simulacrum server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Simulacrum server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"simulacrum", "listmasternodes", &listmasternodes, true, true, false},
        {"simulacrum", "getmasternodecount", &getmasternodecount, true, true, false},
        {"simulacrum", "masternodeconnect", &masternodeconnect, true, true, false},
        {"simulacrum", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"simulacrum", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"simulacrum", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"simulacrum", "masternodecurrent", &masternodecurrent, true, true, false},
        {"simulacrum", "masternodedebug", &masternodedebug, true, true, false},
        {"simulacrum", "startmasternode", &startmasternode, true, true, false},
        {"simulacrum", "createmasternodekey", &createmasternodekey, true, true, false},
        {"simulacrum", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"simulacrum", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"simulacrum", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"simulacrum", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"simulacrum", "getmasternodescores", &getmasternodescores, true, true, false},
        {"simulacrum", "preparebudget", &preparebudget, true, true, false},
        {"simulacrum", "submitbudget", &submitbudget, true, true, false},
        {"simulacrum", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"simulacrum", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"simulacrum", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"simulacrum", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"simulacrum", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"simulacrum", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"simulacrum", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"simulacrum", "checkbudgets", &checkbudgets, true, true, false},
        {"simulacrum", "mnsync", &mnsync, true, true, false},
        {"simulacrum", "spork", &spork, true, true, false},
        {"simulacrum", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> simulacrum-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:59473/\n";
}
